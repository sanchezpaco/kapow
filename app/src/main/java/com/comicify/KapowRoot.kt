...
private data class SettingsRequest(val comics: List<LibraryComic>, val showDetails: Boolean)
                ...
                CompositionLocalProvider(
                    ...
                    when (target) {
                        ...
                        Screen.Library -> LibraryScreen(
                            ...
                            onSetRead = viewModel::onSetRead,
                            onUndoSetRead = viewModel::onUndoSetRead,
                            onSetFavorite = viewModel::onSetFavorite,
                            onUndoSetFavorite = viewModel::onUndoSetFavorite,
                            onDeleteComics = viewModel::onDeleteComics,
                            ...
                            onDragSelecting = viewModel::onDragSelecting,
                            onDragHintShown = viewModel::onDragHintShown,
