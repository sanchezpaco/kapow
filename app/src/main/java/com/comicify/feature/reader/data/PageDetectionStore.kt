...
class PageDetectionStore(private val dao: PageDetectionDao, private val documentUri: String) {
    ...
    private suspend fun find(pageIndex: Int) = dao.find(documentUri, pageIndex, DETECTIONS_VERSION)

    private suspend fun row(pageIndex: Int) =
        find(pageIndex) ?: PageDetectionEntity(documentUri, pageIndex, DETECTIONS_VERSION, panels = null, bubbles = null)
}
