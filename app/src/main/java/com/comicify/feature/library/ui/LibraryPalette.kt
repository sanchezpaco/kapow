...
internal val Ground: Color @Composable @ReadOnlyComposable get() = ComicifyTheme.palette.ground
internal val OnGround: Color @Composable @ReadOnlyComposable get() = ComicifyTheme.palette.onGround
