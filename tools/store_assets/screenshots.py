...
SHOTS = [
    ("phone", "bubbles", {"en-US": ("BIGGER BUBBLES!", "Speech bubbles shown bigger, no zooming"),
                          "es-ES": ("¡BOCADILLOS XL!", "Los bocadillos se ven más grandes sin hacer zoom")}),
    ("phone", "guided", {"en-US": ("GUIDED VIEW", "Each tap takes you to the next panel"),
