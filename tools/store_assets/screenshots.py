...
SHOTS = [
    ("phone", "bubbles", {"en-US": ("BIGGER BUBBLES!", "Small lettering? Kapow makes the balloons bigger, right on the page"),
                          "es-ES": ("¡BOCADILLOS XL!", "¿Letra pequeña? Kapow agranda los bocadillos ahí mismo, en la página")}),
    ("phone", "guided", {"en-US": ("GUIDED VIEW!", "Read panel by panel: tap, and the next one fills your screen"),
                         "es-ES": ("¡VIÑETA A VIÑETA!", "Lee viñeta a viñeta: un toque y la siguiente ocupa toda la pantalla")}),
    ("phone", "library", {"en-US": ("YOUR SHELF!", "Point Kapow at your folder and it turns into a shelf, series by series"),
                          "es-ES": ("¡TU ESTANTERÍA!", "Señala tu carpeta y Kapow la convierte en una estantería, serie por serie")}),
    ("phone", "pagelook", {"en-US": ("OLD SCANS, FIXED", "That yellowed scan from 1952? One tap and it reads like new"),
                           "es-ES": ("PÁGINAS COMO NUEVAS", "¿Ese escaneo amarillento de 1952? Un toque y se lee como nuevo")}),
    ("phone", "search", {"en-US": ("FIND IT FAST", "Type a series, a writer or a year and the right issues show up"),
                         "es-ES": ("ENCUÉNTRALO YA", "Escribe una serie, un guionista o un año y salen justo esos números")}),
    ("phone", "settings", {"en-US": ("YOUR LOOK", "Pure black for OLED, graphite or paper, plus the accent you like"),
                           "es-ES": ("A TU GUSTO", "Negro puro para OLED, grafito o papel, y el acento que más te guste")}),
    ("tablet", "spread", {"en-US": ("TWO PAGES, AS PRINTED", "On a tablet or an open foldable you read the spread, just like paper"),
                          "es-ES": ("DOBLE PÁGINA", "En tablet o con el plegable abierto lees la doble página, como en papel")}),
    ("tablet", "bubbles-spread", {"en-US": ("BIGGER BUBBLES!", "Bigger balloons on the spread too, no need to lean in"),
                                  "es-ES": ("¡BOCADILLOS XL!", "También en la doble página los bocadillos crecen, sin acercarte a la pantalla")}),
    ("tablet", "guided-spread", {"en-US": ("GUIDED VIEW ON SPREADS", "Panel by panel across both pages, whichever side the story is on"),
                                 "es-ES": ("VIÑETA A VIÑETA", "Viñeta a viñeta por las dos páginas, esté donde esté la historia")}),
    ("tablet", "library", {"en-US": ("A WALL OF COVERS", "The big screen shows your whole collection at a glance"),
                           "es-ES": ("PARED DE PORTADAS", "En la pantalla grande cabe toda tu colección de un vistazo")}),
]
COMPARE_SHOTS = {
