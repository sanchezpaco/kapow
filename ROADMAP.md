...
- [x] Launcher icon picker under Settings → Appearance (done 2026-09-04):
      ...
      `tools/store_assets/icon.py`. The cold-start splash keeps the blue logo:
      an alias takes no theme (see `docs/release.md`)
