...
- [x] Animated cold-start splash in the logo's language (2026-08-29): the
      page keylines draw in, fills cascade, the bubble pops, the K slams with
      impact lines and a diagonal wipe reveals the app; 1.3 s, cold start
      only, skipped for `VIEW` intents and "Remove animations"
